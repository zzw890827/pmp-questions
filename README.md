...
110. [单选] 在项目的实施阶段，新法规会影响项目，并且需要召开讨论范围变更的关键状态会议。项目经理发现关键利益相关者无法参加预定的会议。项目经理应该怎么做？
     - [ ] A. 更新沟通管理计划并实施变更。
...
111. [单选] 一名初级工作人员最近被分配到该团队。新团队成员告诉项目经理他们很困惑，因为他们不熟悉项目对他们的期望。项目经理应该做什么来协助新的团队成员？
...
112. [单选] 项目经理有两个同时执行的项目。必须缩短关键项目的工期，但项目经理没有足够的资源来实现这一目标。此外，时间表没有可以重叠的活动。项目经理应该怎么做？
...
113. [单选] 在执行阶段的早期，项目经理发现最近企业环境因素 (EEF) 的变化将大大降低实施成本并缩短项目进度。项目经理应该如何应对这种情况？
...
115. [单选] 发起人支持利用敏捷方法。项目经理正在考虑如何推出敏捷方法并获得项目团队成员和利益相关者的支持。项目经理首先应该做什么？
...
116. [单选] 在检查期间，生产阶段停止，因为检查员声称缺少监管标签。项目经理应该怎么做？
     - [ ] A. 审查风险管理计划。
     - [ ] B. 更新经验教训登记册。
     - [ ] C. 审查质量管理计划。
     - [ ] D. 进行专家判断评估。
...
117. [单选] 某些行业的利益相关者更喜欢直接与程序员和系统分析师打交道，绕过项目经理。这使管理项目资源变得复杂。项目经理应该如何解决这个问题？
     - [ ] A. 要求与高级管理人员会面以升级情况。
...
118. [单选] 维护项目的项目经理有一份每年续签的合同。该项目始于6年前。今年续约后，审计师报告说，这个版本的合同违反了去年通过的新法律。在这种情况下发生了什么？
     - [ ] A. 项目团队没有对合同进行适当的审查。
...
119. [单选] 项目经理已收到更新的挣值分析报告。以下是报告的主要发现：①竣工预算 = 100 万美元；②挣值 = 70 万美元；③实际成本 = 75 万美元；④性价比指数 = 0.933。根据这些信息，项目经理应该对项目绩效得出什么结论？
     - [ ] A. 该项目将完全按计划完成。
     - [ ] B. 项目将比计划更容易完成。
     - [ ] C. 项目将难以按计划完成。
     - [ ] D. 项目不会按计划完成。
...
120. [单选] 一个团队正在举行迄今为止在一个中型项目上构建的软件的首次演示。产品负责人在提供批准之前发现了许多他们希望解决的问题。项目经理应该如何处理这个问题？
...
121. [单选] 一家公司最近使用桌面研究进行可行性研究，结果表明该项目落后于计划。项目团队还担心范围变更对项目进度的影响。项目经理应该怎样做才能在满足项目目标的同时保持项目的进度？
     - [ ] A. 更新范围并向项目添加更多资源。
     - [ ] B. 向CCB提交变更请求并更新时间表。
     - [ ] C. 更新范围并进入下一个项目里程碑。
     - [ ] D. 向CCB提交范围变更申请。
...
122. [单选] 新产品发布项目处于非常初级的阶段，需求也在不断变化。由于市场竞争激烈，客户希望推出范围灵活的产品。项目组打算根据去年交付的类似项目的预测开始工作。哪种项目方法适合该场景？
     - [ ] A. 将其作为 Scrum 项目执行。
     - [ ] B. 使用与参考项目相同的方法执行它。
     - [ ] C. 作为一个带有阶段门的项目来执行它。
     - [ ] D. 将其作为预测项目执行。
...
123. [单选] 客户新任命的技术经理到项目现场验证项目交付成果。技术经理觉得项目经理没有提供足够的信息。项目经理应该首先做什么来解决这种情况？
     - [ ] A. 更新问题日志并上报给项目发起人。
     - [ ] B. 与技术经理安排更频繁的会议。
     - [ ] C. 审查和更新利益相关者参与计划。
     - [ ] D. 将信息缺乏确定为风险并更新风险登记册。
...
124. [单选] 在分析每月状态报告的项目时，项目经理注意到进度绩效指数(SPI)为 0.75，成本绩效指数(CPI)为1.25。项目经理必须尽快提供第一次项目状态审查，并希望强调项目处于受控状态。项目经理应该如何向关键利益相关者报告项目状态？
     - [ ] A. 为利益相关者准备一份关于挣值的详细介绍，包括它的计算方式和项目当前的挣值结果。
     - [ ] B. 使用帕累托图和鱼骨图进行详细的根本原因分析，以证明项目处于受控状态。
     - [ ] C. 报告项目落后于进度，但可以添加额外的有经验的资源以保持进度并维持预算。
     - [ ] D. 报告项目没有按预期进行跟踪，但由于下一个项目里程碑还有一个多月，因此仍在控制之下。
...
126. [选择两项] 一名团队成员与他们的职能经理分享了回顾期间讨论过的另一名团队成员表现的一些负面细节。项目经理发现了这个讨论。项目经理应该采取哪两项行动？
     - [ ] A. 联系团队成员的职能经理并邀请他们参加下一次回顾。
     - [ ] B. 与产品负责人会面，讨论情况。
     - [ ] C. 联系团队成员解释哪些信息可以在团队外共享。
     - [ ] D. 与整个团队会面，审查有关安全环境的基本规则。
     - [ ] E. 与发起人会面以审查情况。
...
127. [连线题] 敏捷项目的新项目经理正在与已建立的团队一起审查一些角色，以避免对预期的内容产生混淆。 将左侧的描述拖到右侧的角色中。
...
128. [单选] 一家公司的CEO刚刚参加了关于人工智能(AI)使用的会议，并希望项目经理在组织中实施这项技术。项目经理首先应该做什么？
     - [ ] A. 开始分析优势、劣势、机会和威胁 (SWOT)。
     - [ ] B. 邀请相关方并分配资源。
     - [ ] C. 进行商业论证。
     - [ ] D. 收集相关方的需求。
     ...
     <details>
       ...
       答案C，解析：PMBOK6 P73：增加项目经理职责

     </details>

129. [单选] 团队成员在未获批准的情况下错过了项目会议，并已按照基本规则的定义受到处罚。该团队成员以及其他团队成员坚持认为这是他们第一次看到有关该项目的此规则，他们不同意处罚。项目经理应该怎么做才能避免这种情况？
     - [ ] A. 将项目章程分发给所有团队成员。
     - [ ] B. 确保团队章程由团队成员制定。
     - [ ] C. 使用魅力型领导风格。
     - [ ] D. 确保团队成员完全支持所有决定。
...
130. [单选] 一个组织正在将敏捷引入其项目。在一次非正式讨论中，项目经理了解到目前在不同团队工作的团队成员正在讨论他们希望如何在同一个团队中在一起。项目经理应该怎么做？
     - [ ] A. 项目经理不应允许资源选择团队，因为项目经理根据项目需要分配资源。
     - [ ] B. 项目经理应该允许资源定期选择他们希望在哪个团队工作。
     - [ ] C. 项目经理不应该让资源选择他们想在哪个团队工作，因为他们总是会选择他们最喜欢的团队。
     - [ ] D. 项目经理应表明团队成员已通过劳动力优化分配到团队。
...
131. [单选] 项目经理正在管理一个非常复杂且执行周期长的项目。 尽管该项目主要是预测性的，但该团队能够使用混合框架将设计和执行分解为更小的包。 业务希望跟踪此框架应用程序交付的价值，但没有为框架定义一组可衡量的项目。项目经理首先应该做什么？
     - [ ] A. 使用与上一个预测项目相同的收益跟踪流程，并将其添加到月度状态报告中。
     - [ ] B. 根据工作分解结构 (WBS) 创建报告并定期更新。
     - [ ] C. 与利益相关者合作确定可以跟踪哪些可衡量的收益，并指派一个负责人来监控和报告这些收益。
     - [ ] D. 研究哪些报告模板最常用于该框架并将其纳入项目。
...
132. [单选] 一位项目经理使用预测方法已经超过 10 年，现在正在转向敏捷项目。团队成员以前没有一起工作过。 两个冲刺的工作，团队没有取得任何成果，工作压力很大。项目经理现阶段应该采用什么样的领导风格？
     - [ ] A. 一种被动的领导风格，允许团队自组织直到达到规范阶段
     - [ ] B. 为团队做出决策以实现早期成果的指导风格
     - [ ] C. 使用多数意见占上风的技巧的民主风格
     - [ ] D. 指导需要帮助的人并促进团队协作的领导风格
...
133. [单选] 项目经理与全球虚拟团队合作。团队面临着彼此沟通困难，经常错过重要信息。这种困难导致错过最后期限。项目经理应该做什么来提高项目团队的效率？
     - [ ] A. 实施团队托管以改善沟通。
     - [ ] B. 确定沟通问题的根本原因。
     - [ ] C. 发起项目进展的日常沟通。
     - [ ] D. 安排一次通信控制委员会会议。
...
134. [单选] 项目经理刚刚开始领导一个项目团队，前任项目经理从该团队辞职。 在对项目进行快速评估后，很明显由于对如何完成任务的持续分歧，团队士气低落。 任务花费的时间比预测的要长，并且项目未按计划进行。项目经理应该怎么做？
     - [ ] A. 通知利益相关者，由于之前的团队管理，项目将被推迟。
     - [ ] B. 打破项目时间表以确保项目按计划进行。
     - [ ] C. 与项目团队开会讨论并解决分歧的根源。
     - [ ] D. 根据确定的延迟发出变更请求以延长项目进度。
...
135. [单选] 团队成员正在与项目经理进行讨论。在上一次回顾会议中，团队意识到过时的设备可能会影响项目的下一次迭代。该团队建议购买新设备，因为这对最终交付的成功至关重要。项目经理接下来应该做什么？
     - [ ] A. 提交变更请求以增加预算并购买新设备。
     - [ ] B. 审查成本管理计划以确定如何解决此问题。
     - [ ] C. 告诉团队成员更多的设备不在项目范围内。
     - [ ] D. 检查项目预算，确认是否有足够的应急储备。
...
136. [单选] 口头宣布加入Scrum团队的新团队成员行动不便。Scrum 主管知道一些团队成员不确定团队的动态将如何变化。Scrum Master 应该怎么做？
     - [ ] A. 召开会议讨论团队必须做出的调整。
     - [ ] B. 制定利益相关者参与计划。
     - [ ] C. 设计一个沟通管理计划。
     - [ ] D. 相应地更新团队章程。
...
137. [单选] 项目经理正在与公司其他职能领域的多个利益相关者一起领导一个项目。其中一个利益相关者刚刚被提升为领导另一个职能领域，并且仍然是该项目的利益相关者。项目经理应该让项目团队更新什么以确保与利益相关者进行适当的沟通？
     - [ ] A. 沟通管理计划
     - [ ] B. 利益相关者参与计划
     - [ ] C. 利益相关者登记册
     - [ ] D. 项目管理计划
...
138. [选择两项] 一个项目团队最近完成了为一家公司开发自动化薪资系统的初始冲刺。项目经理已经安排了与产品所有者和团队成员的冲刺计划会议，以讨论接下来应该处理哪些功能。项目经理需要哪两项信息才能使这次会议富有成效？
     - [ ] A. 冲刺目标
     - [ ] B. 产品待办事项列表
     - [ ] C. 公司使命和愿景
     - [ ] D.燃尽图
...
139. [单选] CEO 已授权为公司开发复杂的金融产品，以提供更大的未来收益。预算是通过与全球投资者一起融资获得的，他们希望尽快识别所有风险。项目经理应该使用什么来识别风险？
     - [ ] A. 风险价值评估
...
140. [单选] 敏捷项目的项目经理被要求将预算减少 30%。由于这是一个小型项目团队，因此预算主要分配给资源。为了在受限环境中持续交付价值，项目经理应该使用什么策略？
     - [ ] A. 将项目范围限制为基本的关键功能，并以当前的人员配备水平运行项目，直到用完所有预算。
     - [ ] B. 减少项目人员并相应调整范围和时间表以支持预算削减。
     - [ ] C. 平衡项目团队以适应预算挑战，并提供培训以减轻低绩效风险。
     - [ ] D. 优先考虑寻找高业务价值和低工作量的产品待办事项，并调整项目预算和人员配备以解决这些项目。
...
141. [选择两项] 在混合项目中，客户签发了一份合同，其中指定了每个季度的可交付成果。 客户希望在第一季度向其利益相关者展示切实的成果，并希望将第二个里程碑移至第一季度。 项目经理向客户解释说，除非第二个里程碑的要求发生变化，否则这是不可行的。项目经理应该采取哪两项行动？
     - [ ] A. 说服客户将第二个里程碑留在原地而不是改变它。
     - [ ] B. 询问客户关于第二个里程碑要求的优先级。
     - [ ] C. 告诉客户移动里程碑对项目成本的影响非常大。
     - [ ] D. 将问题上报给高层管理人员以解决问题，并提出计划。
     - [ ] E. 回到开发团队，讨论可以在第一季度执行哪些第二个里程碑要求。
...
142. [选择两项] 在项目执行期间，项目经理注意到只有一名团队成员具备构建产品所需的一项技术技能。 项目经理担心这可能会对未来的质量和进度产生影响，因为大多数即将开展的活动将需要至少三个具有此特定技能的人。项目经理应该采取哪两项措施来防止团队不合格？
     - [ ] A. 向整个团队传授新技能。
     - [ ] B. 鼓励结对工作和知识共享。
     - [ ] C. 增加对需要这种能力的活动的时间估计。
     - [ ] D. 与外部培训师一起促进培训活动。
...
143. [单选] 在与团队的日常会议期间，项目经理注意到新的团队成员在分配的任务上没有取得预期的进展。 项目经理应该怎么做？
     - [ ] A. 请一位经验丰富的团队成员指导新的团队成员。
     - [ ] B. 要求新团队成员遵守团队基本规则。
     - [ ] C. 请一位经验丰富的团队成员确定替代者。
     - [ ] D. 请新团队成员重新评估自己的能力。
...
144. [单选] 在软件开发项目中，产品所有者和开发团队就冲刺待办事项达成一致。积压工作中的最高优先级是构建支付模块。该团队在 sprint 的前半部分致力于该模块，但现在两名开发人员希望在 sprint 的剩余时间里专注于重构另一个可能在未来产生问题的功能。项目经理应该怎么做？
     - [ ] A. 让开发者专注于重构工作，并在回顾中讨论。
     - [ ] B. 向开发人员重申关注和满足冲刺目标的重要性。
     - [ ] C. 将问题上报给开发人员职能经理。
     - [ ] D. 赞扬开发人员的主动性和对质量的关注。
...
145. [单选] 项目经理在联合应用开发模块上处于快速开发模式。该公司希望在两周内交货。该模块需要在类似的时间线上与其他模块集成，但发布管理有三周的积压。项目经理应该怎么做？
     - [ ] A. 推动团队交付更多，以便根据管理层的要求开发和推出模块。
     - [ ] B. 让团队朝着更紧迫的截止日期努力，以便集成更容易。
     - [ ] C. 与利益相关者交谈以解决瓶颈，并了解如何简化整个流程。
     - [ ] D. 与团队交谈并放慢当前速度以确保团队与发布日期保持一致。
...
146. [单选] 一位项目经理被任命为一个价值数百万美元的项目。该项目被认为是高风险的，因为之前没有进行过类似的项目，也没有历史数据。一些外部利益相关者不愿提供支持。项目经理应该采取什么方法？
     - [ ] A. 检查特定于承担项目的组织的计划、过程、政策和知识。
     - [ ] B. 主持项目团队会议，然后更新风险登记册和项目管理计划。
     - [ ] C. 与利益相关者就项目限制、假设和关键输入建立对话。
     - [ ] D. 说服高级管理层关闭该项目，因为该项目缺乏赞助并且被认为是高风险的。
...
147. [单选] 一个项目团队正在聘请另一个国家的开发团队来开发软件。在进度审查期间，项目经理发现由于对客户需求的不同解释而导致返工导致完成日期延迟。项目经理应该怎么做？
     - [ ] A. 与主要利益相关者召开会议以澄清要求。
     - [ ] B. 上报给项目指导委员会并要求额外的时间。
     - [ ] C. 与开发团队一起创建原型以确认需求。
     - [ ] D. 前往开发团队的办公室推动日程安排。
...
148. [单选] 在与客户会面后，项目经理得到了特别的认可，因为项目总是按计划进行。 当天晚些时候，项目经理参加定期的项目团队会议，以跟进可交付成果的状态。项目经理在项目组会议上应该做什么？
     - [ ] A. 按照会议议程列出下一个可交付成果。
     - [ ] B. 与项目团队分享客户反馈。
     - [ ] C. 在会议记录中记录此反馈。
...
149. [单选] 团队正在处理一个关键的项目可交付成果，而项目经理担心能否在截止日期前完成。一些利益相关者对一些团队成员的表现提出了投诉。项目经理希望了解情况并尽快向团队提供反馈。项目经理应该采取哪三项措施来解决这种情况？
     - [ ] A. 实施每日团队会议。
     - [ ] B. 定义团队基本规则。
     - [ ] C. 进行回顾会议。
     - [ ] D. 进行年度审查。
...
150. [单选] 在规划会议之后，一个新项目已经启动。 该项目由组织中的一名高管直接监督。 在审查会议之后，项目经理无意中听到高管要求其中一名团队成员使用仪表板来显示整体项目状态。项目经理应该怎么做？
     - [ ] A. 更新沟通管理计划以包括非正式请求。
     - [ ] B. 要求团队成员开发仪表板来满足请求。
     - [ ] C. 更新利益相关者参与评估矩阵。
     - [ ] D. 告诉团队成员通过项目经理路由请求。
...
151. [单选] 项目经理被分配到一家正在过渡到敏捷的公司的项目。并非所有利益相关者都相信该项目，一些利益相关者希望在项目早期就定义和规划整个项目。但是，项目发起人需要快速获胜才能确保项目的继续进行。项目经理应该使用什么方法？
     - [ ] A. 混合项目，因为这将减轻利益相关者的担忧。
     - [ ] B. 一种预测方法，因为这会取悦高级利益相关者。
     - [ ] C. 一种预测方法，因为这将为所有利益相关者带来好处。
     - [ ] D. 一种敏捷方法，因为这将更早地提供工作功能。
...
152. [单选] 在收集了依赖于外部利益相关者的项目的所有需求之后，项目团队正在完成第二次迭代。此时，项目经理了解到可能会阻止产品发布的法规变更。项目经理应该怎么做才能实现收益？
     - [ ] A. 实施更改。
     - [ ] B. 提高团队的速度。
     - [ ] C. 在风险日志中添加一个条目。
     - [ ] D. 审查目标收益。
...
154. [单选] 一家公司的项目管理办公室 (PMO) 已开始实施迭代工具。项目经理正在开始一个新项目，并确定了使用迭代工具的机会。一位高级经理对这个修改后的框架感到担忧，因为它对公司来说是相当新的。项目经理首先应该做什么？
     - [ ] A. 向高级经理发送有关新框架优势的文档。
     - [ ] B. 将高级经理的关注上报给项目发起人，并将状态分发给团队。
     - [ ] C. 寻找有关新框架的外部培训，以消除利益相关者参与度低的风险。
     - [ ] D. 组织与利益相关者的个别会议，以建立对新框架的认识和信任。
...
155. [选择两项] 在不同国家的特定用户完成一个项目后，项目经理的主管会询问项目用户是否对项目的运行方式感到满意。 项目经理应该采取哪两项行动？
     - [ ] A. 向项目参与者发送问卷并寻求他们的反馈。
     - [ ] B. 准备从项目阶段吸取的经验教训。
     - [ ] C. 将项目资料交给用户，看看他们有没有意见。
     - [ ] D. 获得各国对新工艺的正式批准。
     - [ ] E. 参考沟通管理计划。
...
156. [单选] 在回顾会议期间，项目经理听到利益相关者一直在迭代演示中抱怨产品功能未按要求交付。项目经理应该给产品负责人什么建议，以确保产品功能始终按要求交付？
     - [ ] A. 在积压工作细化之前与利益相关者一起验证验收标准。
     - [ ] B. 避免在迭代评审中包括利益相关者。
     - [ ] C. 在每日站立会议中包括利益相关者以监控进度。
     - [ ] D. 创建一个需求可追溯性矩阵并相应地分发它。
...
157. [单选] 项目经理负责搭建桥梁。 使用预测方法处理项目的高级元素。负责收回桥梁的软件是基于敏捷原则开发的。在软件开发过程中，由于缺乏信息，工作流程经常被各种延迟或障碍所打断。项目经理应该如何处理这种情况？
     - [ ] A. 应用精益制造来限制团队的工作。
     - [ ] B. 使用看板使工作可见。
     - [ ] C. 将小批量的工作合并到项目中。
     - [ ] D. 增加回顾以快速交付结果。
...
158. [单选] 项目团队难以理解有关需求的技术细节。该信息最初并非由客户提供，但该信息在当前迭代中对于阐明需要如何完成任务至关重要。项目经理应该如何处理这种情况？
     - [ ] A. 要求客户审查并澄清当前 sprint 的功能定义。
     - [ ] B. 将当前冲刺的燃尽图发送给客户并寻求说明。
     - [ ] C. 教育客户并让他们参加每日站立会议。
     - [ ] D. 与客户安排每周会议和产品审查，以明确要求。
...
159. [单选] 一个团队已经在一个项目上工作了几个月，但完成日期尚不清楚，因为随着新知识的获得，范围经常变化。一些可交付成果已经完成，但是当新的利益相关者加入团队时，他们抱怨项目结果没有达到业务目标。项目经理如何才能防止这种情况在未来发生？
     - [ ] A. 为每个项目阶段安排启动会议，与所有利益相关者分享项目管理计划。
     - [ ] B. 创建所有利益相关者批准的详细工作分解结构 (WBS) 和里程碑时间表。
     - [ ] C. 创建优先待办事项并与利益相关者一起定义迭代审查会议。
     - [ ] D. 安排每日会议以审查团队绩效和障碍。
...
160. [单选] 在启动新产品改进项目期间，项目经理发现历史数据表明，类似项目导致客户抱怨与以前的产品版本相比更差的用户体验。 项目经理如何在新项目中防止这种结果？
     - [ ] A. 聘请顾问进行收益分析，作为项目章程的输入。
     - [ ] B. 在完成工作分解结构 (WBS) 后定义高级别风险并计划缓解。
     - [ ] C. 将用户焦点小组定义为对结果有很大影响的外部利益相关者。
     - [ ] D. 聘请外部用户团队对产品进行验收测试。
...
161. [单选] 一个团队对如何解决在建产品的一个特性有不同的想法，虽然sprint在两天前就开始了，但他们仍然没有达成共识。项目经理应该怎么做？
     - [ ] A. 安排一个会议，让每个人都有机会表达他们对每个想法的看法，然后投票并做出决定。
     - [ ] B. 就每个想法的利弊发表意见，并尝试在促进会议上达成共识。
     - [ ] C. 请产品负责人（主要利益相关者）在不同的想法中进行选择。
     - [ ] D. 向小组提出想法，请大家投票，然后选出最受欢迎的想法。
...
162. [单选] 为了估算与去年实施的项目类似的新项目的成本，项目经理会见了上一项目的一组专家。 该小组使用三点估计技术。项目经理将预算预算提交给项目发起人审批。新来公司的项目发起人担心，因为预算超出了他们的预期。项目经理应该怎么做？
     - [ ] A. 回顾从去年的项目中吸取的历史信息和经验教训，以证明新预算的合理性。
     - [ ] B. 使用软技能来说服项目发起人批准新的预算估算。
     - [ ] C. 将预算技术更改为更准确、自下而上的成本估算。
     - [ ] D. 审查组织过程评估以确定是否在预算估计中考虑了应急准备金。
...
163. [单选] 一个组织正在向敏捷过渡，并且一个项目已被选为试点。指定的项目经理只有使用预测方法的经验，但现在要求项目经理在敏捷教练的帮助下使用敏捷方法。在第五个冲刺的回顾中，项目团队抱怨组织中存在许多障碍，导致项目延迟和返工。在这种情况下，项目经理应该怎么做？
     - [ ] A. 在站立会议期间进行根本原因分析。
     - [ ] B. 创建一个专门的冲刺，与团队一起解决障碍。
     - [ ] C. 在每日站立会议中加入障碍解决方案。
     - [ ] D. 促进协作以帮助消除团队的障碍。
...
164. [单选] 项目团队的一些成员对以前在 Scrum 环境中工作过的新团队成员感到沮丧。这个新的团队成员每天都会与项目团队的成员接触，似乎是为了参加单独的站立会议。项目经理应该怎么做？
     - [ ] A. 告诉项目团队的其他成员继续与新团队成员讨论。
     - [ ] B. 向项目团队发送电子邮件，概述沟通策略。
     - [ ] C. 为项目团队安排一次会议以审查沟通管理计划。
...
165. [单选] 经过几次迭代后，项目经理决定向关键利益相关者展示产品。利益相关者的反馈是，该团队在许多功能上都没有达到目标。项目经理应该怎么做才能避免将来发生这种情况？
     - [ ] A. 安排足够的冲刺演示以收集利益相关者的早期反馈并相应地调整计划。
     - [ ] B. 与所有主要利益相关者建立需求收集会议，再次评估范围并根据会议重新确定待办事项的优先级。
     - [ ] C. 评估团队的技能，寻找具有产品设计经验的人，并将重建产品界面的任务分配给该人。
     - [ ] D. 将设计思维实践纳入项目生命周期，以更好地了解产品的角色并更有效地满足他们的需求。
...
166. [单选] 由于项目利益相关者之间存在分歧，项目经理难以获得项目要求的批准。这个问题使项目进度处于危险之中。项目经理首先应该做什么来促进项目需求的批准？
     - [ ] A. 确定分歧的来源。
     - [ ] B. 举办团队建设活动。
     - [ ] C. 进行利益相关者分析。
     - [ ] D. 审查项目章程。
...
167. [单选] 一个敏捷项目正在运行八次迭代中的第五次。经过最后一次迭代规划，团队得知市场上出现了新的竞争者，需要加快行动，确保市场份额不被错过。项目经理应该怎么做？
     - [ ] A. 将竞争对手的功能添加到产品待办列表中以改进产品。
     - [ ] B. 帮助团队寻找新的方法尽快推出产品。
     - [ ] C. 要求团队加快推出产品的速度。
     - [ ] D. 要求赞助商为团队增加更多人。
...
168. [单选] 一位外部项目经理正在为一家大公司管理新公司办公室的建设。项目管理计划指出，有必要聘请训练有素的外部资源来修改和验证重要的项目组成部分。由于成本高，客户拒绝雇用外部资源，即使它在项目预算范围内。项目经理应该怎么做才能解决这个问题？
     - [ ] A. 要求客户开会并解释将不会执行任务。
     - [ ] B. 评估后果并与客户会面以解释可能出现的情况。
     - [ ] C. 尝试通过平衡其他项目的资源在内部完成任务。
     - [ ] D. 雇用资源以实现项目目标。
...
169. [单选] 一位新的项目经理正在为一家位于不同国家/地区的公司规划信息安全项目。项目经理在收集客户需求时应该采取的第一步是什么？
     - [ ] A. 要求相关利益相关者独立进行分析并达成共识。
     - [ ] B. 进行利益相关者分析以确定区域政策如何影响需求。
     - [ ] C. 与相关利益相关者在一处召开项目规划会议。
     - [ ] D. 与相关利益相关者一起举办项目范围审查研讨会。
...
170. [单选] 在建设项目的实施阶段，客户要求关键分包商提前交付工作包。分包商对此毫无准备，并要求项目经理追加预算。项目经理首先应该做什么？
     - [ ] A. 提交变更请求以按要求加速项目。
     - [ ] B. 要求上级管理更多的资金，并更新项目预算。
     - [ ] C. 更新风险登记册和项目日志，并密切管理预算。
     - [ ] D. 相应地修改项目范围以应对预算变化。
...
171. [单选] 项目经理已被分配到项目并从项目管理办公室 (PMO) 收到项目章程。该文件对客户要求非常清楚。在项目范围管理期间，某些要求似乎与项目章程中规定的要求不同。项目经理应该怎么做？
     - [ ] A. 在配置管理计划中注册变更并将其发送到变更控制委员会 (CCB)。
     - [ ] B. 向发起人解释这些请求可能危及项目的进度和成本。
     - [ ] C. 使用焦点小组和头脑风暴会议来收集有关项目范围的更多详细信息。
     - [ ] D. 修改项目基线对项目范围的轻微影响变化。
...
172. [单选] 敏捷项目正在运行定义最小可行产品 (MVP) 的活动。在会议期间，项目经理确定了一些强制性规定，但没有达成共识将这些规定包含在MVP中，因为这可能会延长项目的持续时间。项目经理应该怎么做？
...
173. [单选] 新项目经理了解到分配给团队的工作已经分解到最低级别。项目经理审查工作并觉得缺少一些额外的、有用的信息。项目经理应该审查什么？
     - [ ] A. 项目章程和范围说明书
     - [ ] B. WBS 词典
     - [ ] C. 需求追溯矩阵
     - [ ] D. 业务需求文件（BRD）
...
174. [连线题] 项目经理担心关键利益相关者没有参与项目，并得出结论，如果利益相关者更多地参与，最终产品不如预期的好。 将左侧的场景拖到右侧的正确风险应对策略中。
...
175. 一个研发团队正在完成一项为期两年的计划。项目经理专注于项目的收尾活动。应优先考虑哪些活动？
     - [ ] A. 为项目完成庆祝活动释放资源和计划。
     - [ ] B. 召开指导委员会会议，通知他们项目完成情况。
     - [ ] C. 确保知识转移活动按计划执行。
...
176. 一家公司决定实施一个新的归档系统。在项目实施过程中发生了数据泄露。项目经理首先应该做什么？
     - [ ] A. 实施计划的风险应对措施来处理问题。
     - [ ] B. 用风险和建议的影响更新风险登记册。
     - [ ] C. 要求团队修复系统以解决问题。
     - [ ] D. 与团队一起审查可能的替代文档方法。
...
177. 一个由来自许多不同国家的成员组成的项目团队正在努力合作。项目经理在团队发展的风暴阶段接受了这些困难，但团队并没有进入下一阶段。该项目开始落后于计划。项目经理可以做些什么来使团队进入规范阶段？
     - [ ] A. 向团队展示他们的沟通问题对日程安排的影响，并鼓励他们搁置分歧。
     - [ ] B. 与项目发起人讨论改变团队组成。
     - [ ] C. 找出问题的幕后黑手并应用渐进式纪律处分技巧。
     - [ ] D. 计划社交活动以帮助培养更牢固的人际关系并确定共同目标。
...
178. 在日常通话中，团队成员共享任务进度。一名团队成员通常不会传达很多细节，并且有要完成的关键任务。所有团队成员都位于不同的国家，关键工作即将开始。在这种情况下，哪两个选项对项目经理有帮助？
     - [ ] A. 将工作重新分配给参与日常通话的资源。
     - [ ] B. 向职能经理报告团队成员的糟糕表现。
     - [ ] C. 要求团队发送包含详细任务进度的电子邮件。
     - [ ] D. 鼓励所有团队成员使用虚拟工作空间。
     - [ ] E. 与团队成员讨论他们的参与情况并采取适当的行动。
...
179. 一家公司的项目管理办公室 (PMO) 一直在尝试在项目管理框架中实施自适应方法，并且已要求项目经理在其下一个项目中使用自适应工具。 这不是第一次提出请求，而且之前的项目在实施自适应工具时失败了。项目经理应该怎么做？
     - [ ] A. 准备变更请求并就新项目框架寻求指导委员会的批准。
     - [ ] B. 向 PMO 建议现在不是开始在项目中实施自适应工具的合适时机。
     - [ ] C. 引入第三方公司为该特定项目开发和实施混合框架。
     - [ ] D. 与主要利益相关者进行个别访谈以了解所有问题，然后准备沟通管理计划。
...
180. 项目经理了解到项目发起人对项目需求的制定不满意。 为了使项目符合发起人的期望，项目经理应该做什么？
     - [ ] A. 进行利益相关者评估。
     - [ ] B. 与团队一起审查项目目标图。
     - [ ] C. 确认团队应该使用哪些模板。
     - [ ] D. 审查风险管理计划。
     ...
     <details>
       ...
       答案B -> [ref](https://www.pmi.org/disciplined-agile/ip-architecture/how-to-read-process-goal-diagrams)
